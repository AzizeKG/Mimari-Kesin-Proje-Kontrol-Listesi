...
namespace Mimari_Kesin_Proje_Kontrol_Listesi
{
    ...
    public partial class VeriGirisiY2 : System.Windows.Forms.Form
    {
        ...
        public VeriGirisiY2(ExternalCommandData commandData)
        {
            InitializeComponent();
        ...
        private void VeriGirisiY2_Load(object sender, EventArgs e)
        {
            ...
            {
                var oku1 = vt.Sorgu("select kontrol, aciklama_danisman,kullanici_adi,soru_id from checklist");
                ...
                while (reader.Read())
                {
                    ...
                    var kullanici_adi = reader.IsDBNull(2) ? "" : reader.GetString(2);
                    var soru_id = reader.IsDBNull(3) ? 0 : reader.GetInt32(3);
        ...
        private void btnKontrol_Click(object sender, EventArgs e)
        {
            using (Veritabani vt = new Veritabani())
            {
                var yaz = vt.Sorgu($"UPDATE durum SET durum='RM' WHERE id={DurumId};");
                yaz.ExecuteNonQuery();
            }
            ...
            NpgsqlCommand komut1 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4 WHERE soru_id=1;", baglanti);
            ...
            baglanti.Close();
            MessageBox.Show("Kontrole Gönderildi");
        }
