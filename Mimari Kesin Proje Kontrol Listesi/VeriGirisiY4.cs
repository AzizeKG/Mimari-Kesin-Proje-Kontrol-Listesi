...
namespace Mimari_Kesin_Proje_Kontrol_Listesi
{
    ...
    public partial class VeriGirisiY4 : System.Windows.Forms.Form
    {
        ...
        public VeriGirisiY4(ExternalCommandData commandData)
        {
            InitializeComponent();
        ...
        public void InitForm(UserRole rol)
        {
            Rol = rol;

            if (Rol == UserRole.Danisman)
            {
                DanismanFormuOlustur();
            }
            else if (Rol == UserRole.Yuklenici)
            {
                YukleniciFormuOlustur();
            }
            else if (Rol == UserRole.Isveren)
            {
                IsverenFormuOlustur();
                IsverenVeriOku();
            }
        ...
        private void DanismanFormuOlustur()
        {
            lbl7.Visible = false;
        ...
        private void IsverenFormuOlustur()
        {
            lbl7.Visible = false;
            textBx4.Visible = false;
            textBx8.Visible = false;
        ...
        private void YukleniciFormuOlustur()
        {
            textBx3.ReadOnly = true;
            textBx7.ReadOnly = true;
            textBx11.ReadOnly = true;
            ...
            baglanti.Open();
            NpgsqlCommand oku1 = new NpgsqlCommand("select kontrol, aciklama_danisman, revizyon,kullanici_adi from checklist", baglanti);

            NpgsqlDataReader reader = oku1.ExecuteReader();
            var kontroller = new List<bool>();
            var aciklamalar = new List<string>();
            var revizyonlar = new List<string>();
            ...
            while (reader.Read())
            {
                ...
                var revizyon = reader.IsDBNull(2) ? "" : reader.GetString(2);
                var kullanici_adi = reader.IsDBNull(3) ? "" : reader.GetString(3);
                kontroller.Add(kontrol);
                aciklamalar.Add(aciklama_danısman);
                revizyonlar.Add(revizyon);
                kullanicilar.Add(kullanici_adi);

            }
            // 1. Yanıt ve Kullanıcı Bilgileri okuma 
            checkBx1.Checked = kontroller[0];
            textBx3.Text = aciklamalar[0];
            textBx67.Text = kullanicilar[0];

            //2. Yanıt 
            checkBx2.Checked = kontroller[1];
            textBx7.Text = aciklamalar[1];
            //3. Yanıt 
            checkBx3.Checked = kontroller[2];
            textBx11.Text = aciklamalar[2];
            // 4. Yanıt 
            checkBx4.Checked = kontroller[3];
            textBx15.Text = aciklamalar[3];
            // 5. Yanıt 
            checkBx5.Checked = kontroller[4];
            textBx23.Text = aciklamalar[4];
            // 6. Yanıt 
            checkBx6.Checked = kontroller[5];
            textBx27.Text = aciklamalar[5];
            // 7. Yanıt 
            checkBx7.Checked = kontroller[6];
            textBx32.Text = aciklamalar[6];
            // 8. Yanıt 
            checkBx8.Checked = kontroller[7];
            textBx36.Text = aciklamalar[7];
            // 9. Yanıt 
            checkBx9.Checked = kontroller[8];
            textBx40.Text = aciklamalar[8];
            // 10. Yanıt 
            checkBx10.Checked = kontroller[9];
            textBx44.Text = aciklamalar[9];
            // 11. Yanıt 
            checkBx11.Checked = kontroller[10];
            textBx48.Text = aciklamalar[10];
            // 12. Yanıt 
            checkBx12.Checked = kontroller[11];
            textBx52.Text = aciklamalar[11];
            // 13. Yanıt 
            checkBx13.Checked = kontroller[12];
            textBx56.Text = aciklamalar[12];
            // 14. Yanıt 
            chckBx14.Checked = kontroller[13];
            texBx27.Text = aciklamalar[13];
            // 15. Yanıt 
            checkBx15.Checked = kontroller[14];
            textBx64.Text = aciklamalar[14];
            // 16. Yanıt 
            chckBx1.Checked = kontroller[15];
            texBx1.Text = aciklamalar[15];
            // 17. Yanıt 
            chckBx2.Checked = kontroller[16];
            texBx3.Text = aciklamalar[16];
            // 18. Yanıt 
            chckBx3.Checked = kontroller[17];
            texBx5.Text = aciklamalar[17];
            // 19. Yanıt 
            chckBx4.Checked = kontroller[18];
            texBx7.Text = aciklamalar[18];
            // 20. Yanıt 
            chckBx5.Checked = kontroller[19];
            texBx9.Text = aciklamalar[19];
            // 21. Yanıt 
            chckBx6.Checked = kontroller[20];
            texBx11.Text = aciklamalar[20];
            // 22. Yanıt 
            chckBx7.Checked = kontroller[21];
            texBx13.Text = aciklamalar[21];
            // 23. Yanıt 
            chckBx8.Checked = kontroller[22];
            texBx15.Text = aciklamalar[22];
            // 24. Yanıt
            chckBx9.Checked = kontroller[23];
            texBx17.Text = aciklamalar[23];
            // 25. Yanıt 
            chckBx10.Checked = kontroller[24];
            texBx19.Text = aciklamalar[24];
            // 26. Yanıt 
            chckBx11.Checked = kontroller[25];
            texBx21.Text = aciklamalar[25];
            // 27. Yanıt 
            chckBx12.Checked = kontroller[26];
            texBx23.Text = aciklamalar[26];
            // 28. Yanıt 
            chckBx13.Checked = kontroller[27];
            texBx25.Text = aciklamalar[27];
            // 29. Yanıt 
            chckBx14.Checked = kontroller[28];
            texBx27.Text = aciklamalar[28];
            // 30. Yanıt 
            chckBx15.Checked = kontroller[29];
            texBx29.Text = aciklamalar[29];
            // 31. Yanıt 
            chckBx16.Checked = kontroller[30];
            texBx31.Text = aciklamalar[30];
            // 32. Yanıt 
            chckBx17.Checked = kontroller[31];
            texBx33.Text = aciklamalar[31];
            // 33. Yanıt 
            chckBx18.Checked = kontroller[32];
            texBx35.Text = aciklamalar[32];
            // 34. Yanıt 
            chckBx19.Checked = kontroller[33];
            texBx37.Text = aciklamalar[33];
            // 35. Yanıt 
            chckBx20.Checked = kontroller[34];
            texBx39.Text = aciklamalar[34];
            baglanti.Close();


        }

        private void IsverenVeriOku()
        {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut1 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman,aciklama_yuklenici,revizyon,kullanici_adi) values (@p1,@p2,@p3,@p4,@p5,@p6)", baglanti);
            ...
            // 2. soru 
            NpgsqlCommand komut2 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 3. soru 
            NpgsqlCommand komut3 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 4. soru
            NpgsqlCommand komut4 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 5. soru
            NpgsqlCommand komut5 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 6. soru
            NpgsqlCommand komut6 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 7. soru 
            NpgsqlCommand komut7 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 8. soru
            NpgsqlCommand komut8 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 9. soru 
            NpgsqlCommand komut9 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 10. soru
            NpgsqlCommand komut10 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 11. soru
            NpgsqlCommand komut11 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 12. soru
            NpgsqlCommand komut12 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 13. soru
            NpgsqlCommand komut13 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 14. soru
            NpgsqlCommand komut14 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 15. soru 
            NpgsqlCommand komut15 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 1. soru
            NpgsqlCommand komut16 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 2. soru
            NpgsqlCommand komut17 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 3. soru
            NpgsqlCommand komut18 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 4. soru
            NpgsqlCommand komut19 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 5. soru
            NpgsqlCommand komut20 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 6. soru
            NpgsqlCommand komut21 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 7. soru
            NpgsqlCommand komut22 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 8. soru
            NpgsqlCommand komut23 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 9. soru
            NpgsqlCommand komut24 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 10. soru
            NpgsqlCommand komut25 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 11. soru
            NpgsqlCommand komut26 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 12. soru
            NpgsqlCommand komut27 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 13. soru
            NpgsqlCommand komut28 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 14. soru
            NpgsqlCommand komut29 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 15. soru
            NpgsqlCommand komut30 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 16. soru
            NpgsqlCommand komut31 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 17. soru
            NpgsqlCommand komut32 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 18. soru
            NpgsqlCommand komut33 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 19. soru
            NpgsqlCommand komut34 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
            ...
            // 2. sayfa 20. soru
            NpgsqlCommand komut35 = new NpgsqlCommand("insert into checklist (label_adi,kontrol,aciklama_danisman) values (@p1,@p2,@p3)", baglanti);
