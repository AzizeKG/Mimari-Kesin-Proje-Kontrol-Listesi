...
namespace Mimari_Kesin_Proje_Kontrol_Listesi
{
    ...
    public partial class VeriGirisiI1 : System.Windows.Forms.Form
    {
        ...
        public VeriGirisiI1(ExternalCommandData commandData)
        {
            InitializeComponent();
        ...
        private void VeriGirisiI1_Load(object sender, EventArgs e)
        {
            ...
            // Danışman Notları Değiştirilemez
            textBx3.ReadOnly = true;
            textBx7.ReadOnly = true;
            textBx11.ReadOnly = true;
            textBx15.ReadOnly = true;
            textBx23.ReadOnly = true;
            textBx27.ReadOnly = true;
            textBx32.ReadOnly = true;
            textBx36.ReadOnly = true;
            textBx40.ReadOnly = true;
            textBx44.ReadOnly = true;
            textBx48.ReadOnly = true;
            textBx52.ReadOnly = true;
            textBx56.ReadOnly = true;
            textBx60.ReadOnly = true;
            textBx64.ReadOnly = true;
            texBx1.ReadOnly = true;
            texBx3.ReadOnly = true;
            texBx5.ReadOnly = true;
            texBx7.ReadOnly = true;
            texBx9.ReadOnly = true;
            texBx11.ReadOnly = true;
            texBx13.ReadOnly = true;
            texBx15.ReadOnly = true;
            texBx17.ReadOnly = true;
            texBx19.ReadOnly = true;
            texBx21.ReadOnly = true;
            texBx23.ReadOnly = true;
            texBx25.ReadOnly = true;
            texBx27.ReadOnly = true;
            texBx29.ReadOnly = true;
            texBx31.ReadOnly = true;
            texBx33.ReadOnly = true;
            texBx35.ReadOnly = true;
            texBx37.ReadOnly = true;
            texBx39.ReadOnly = true;
            textBx67.ReadOnly = true;
        ...
        private void btnVeriKayıt_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                // Heder Klasöre Dosyayı Kopyalama İşlemi
        ...
        private void btnOnay_Click(object sender, EventArgs e)
        {
            using (Veritabani vt = new Veritabani())
            {
                var yaz = vt.Sorgu($"UPDATE durum SET durum='ONAY' WHERE id={DurumId};");
                yaz.ExecuteNonQuery();
            }
            Close();
        }
        ...
        private void btnRet_Click(object sender, EventArgs e)
        {
            using (Veritabani vt = new Veritabani())
            {
                var yaz = vt.Sorgu($"UPDATE durum SET durum='ORT' WHERE id={DurumId};");
                yaz.ExecuteNonQuery();
            }
            Close();
            ...
            NpgsqlCommand komut1 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5,kullanici_adi=@p6 WHERE soru_id=1;", baglanti);
            ...
            komut1.Parameters.AddWithValue("@p5", textBoxi1.Text);
            komut1.Parameters.AddWithValue("@p6", textBx67.Text);
            komut1.ExecuteNonQuery();
            // 2. soru 
            NpgsqlCommand komut2 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=2;", baglanti);
            ...
            komut2.Parameters.AddWithValue("@p5", textBoxi2.Text);
            komut2.ExecuteNonQuery();
            // 3. soru 
            NpgsqlCommand komut3 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=3;", baglanti);
            ...
            komut3.Parameters.AddWithValue("@p5", textBoxi3.Text);
            komut3.ExecuteNonQuery();
            // 4. soru
            NpgsqlCommand komut4 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=4;", baglanti);
            ...
            komut4.Parameters.AddWithValue("@p5", textBoxi4.Text);
            komut4.ExecuteNonQuery();
            // 5. soru
            NpgsqlCommand komut5 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=5;", baglanti);
            ...
            komut5.Parameters.AddWithValue("@p5", textBoxi5.Text);
            komut5.ExecuteNonQuery();
            // 6. soru
            NpgsqlCommand komut6 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=6;", baglanti);
            ...
            komut6.Parameters.AddWithValue("@p5", textBoxi6.Text);
            komut6.ExecuteNonQuery();
            // 7. soru 
            NpgsqlCommand komut7 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=7;", baglanti);
            ...
            komut7.Parameters.AddWithValue("@p5", textBoxi7.Text);
            komut7.ExecuteNonQuery();
            // 8. soru
            NpgsqlCommand komut8 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=8;", baglanti);
            ...
            komut8.Parameters.AddWithValue("@p5", textBoxi8.Text);
            komut8.ExecuteNonQuery();
            // 9. soru 
            NpgsqlCommand komut9 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=9;", baglanti);
            ...
            komut9.Parameters.AddWithValue("@p5", textBoxi9.Text);
            komut9.ExecuteNonQuery();
            // 10. soru
            NpgsqlCommand komut10 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=10;", baglanti);
            ...
            komut10.Parameters.AddWithValue("@p5", textBoxi10.Text);
            komut10.ExecuteNonQuery();
            // 11. soru
            NpgsqlCommand komut11 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=11;", baglanti);
            ...
            komut11.Parameters.AddWithValue("@p5", textBoxi11.Text);
            komut11.ExecuteNonQuery();
            // 12. soru
            NpgsqlCommand komut12 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=12;", baglanti);
            ...
            komut12.Parameters.AddWithValue("@p5", textBoxi12.Text);
            komut12.ExecuteNonQuery();
            // 13. soru
            NpgsqlCommand komut13 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=13;", baglanti);
            ...
            komut13.Parameters.AddWithValue("@p5", textBoxi13.Text);
            komut13.ExecuteNonQuery();
            // 14. soru
            NpgsqlCommand komut14 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=14;", baglanti);
            ...
            komut14.Parameters.AddWithValue("@p5", textBoxi14.Text);
            komut14.ExecuteNonQuery();
            // 15. soru 
            NpgsqlCommand komut15 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=15;", baglanti);
            ...
            komut15.Parameters.AddWithValue("@p5", textBoxi15.Text);
            komut15.ExecuteNonQuery();
            // 2. sayfa 1. soru
            NpgsqlCommand komut16 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=16;", baglanti);
            ...
            komut16.Parameters.AddWithValue("@p5", textBoxik1.Text);
            komut16.ExecuteNonQuery();
            // 2. sayfa 2. soru
            NpgsqlCommand komut17 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=17;", baglanti);
            ...
            komut17.Parameters.AddWithValue("@p5", textBoxik2.Text);
            komut17.ExecuteNonQuery();
            // 2. sayfa 3. soru
            NpgsqlCommand komut18 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=18;", baglanti);
            ...
            komut18.Parameters.AddWithValue("@p5", textBoxik3.Text);
            komut18.ExecuteNonQuery();
            // 2. sayfa 4. soru
            NpgsqlCommand komut19 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=19;", baglanti);
            ...
            komut19.Parameters.AddWithValue("@p5", textBoxik4.Text);
            komut19.ExecuteNonQuery();
            // 2. sayfa 5. soru
            NpgsqlCommand komut20 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=20;", baglanti);
            ...
            komut20.Parameters.AddWithValue("@p5", textBoxik5.Text);
            komut20.ExecuteNonQuery();
            // 2. sayfa 6. soru
            NpgsqlCommand komut21 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=21;", baglanti);
            ...
            komut21.Parameters.AddWithValue("@p5", textBoxik6.Text);
            komut21.ExecuteNonQuery();
            // 2. sayfa 7. soru
            NpgsqlCommand komut22 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=22;", baglanti);
            ...
            komut22.Parameters.AddWithValue("@p5", textBoxik7.Text);
            komut22.ExecuteNonQuery();
            // 2. sayfa 8. soru
            NpgsqlCommand komut23 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=23;", baglanti);
            ...
            komut23.Parameters.AddWithValue("@p5", textBoxik8.Text);
            komut23.ExecuteNonQuery();
            // 2. sayfa 9. soru
            NpgsqlCommand komut24 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=24;", baglanti);
            ...
            komut24.Parameters.AddWithValue("@p5", textBoxik9.Text);
            komut24.ExecuteNonQuery();
            // 2. sayfa 10. soru
            NpgsqlCommand komut25 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=25;", baglanti);
            ...
            komut25.Parameters.AddWithValue("@p5", textBoxik10.Text);
            komut25.ExecuteNonQuery();
            // 2. sayfa 11. soru
            NpgsqlCommand komut26 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=26;", baglanti);
            ...
            komut26.Parameters.AddWithValue("@p5", textBoxik11.Text);
            komut26.ExecuteNonQuery();
            // 2. sayfa 12. soru
            NpgsqlCommand komut27 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=27;", baglanti);
            ...
            komut27.Parameters.AddWithValue("@p5", textBoxik12.Text);
            komut27.ExecuteNonQuery();
            // 2. sayfa 13. soru
            NpgsqlCommand komut28 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=28;", baglanti);
            ...
            komut28.Parameters.AddWithValue("@p5", textBoxik13.Text);
            komut28.ExecuteNonQuery();
            // 2. sayfa 14. soru
            NpgsqlCommand komut29 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=29;", baglanti);
            ...
            komut29.Parameters.AddWithValue("@p5", textBoxik14.Text);
            komut29.ExecuteNonQuery();
            // 2. sayfa 15. soru
            NpgsqlCommand komut30 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=30;", baglanti);
            ...
            komut30.Parameters.AddWithValue("@p5", textBoxik15.Text);
            komut30.ExecuteNonQuery();
            // 2. sayfa 16. soru
            NpgsqlCommand komut31 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=31;", baglanti);
            ...
            komut31.Parameters.AddWithValue("@p5", textBoxik16.Text);
            komut31.ExecuteNonQuery();
            // 2. sayfa 17. soru
            NpgsqlCommand komut32 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=32;", baglanti);
            ...
            komut32.Parameters.AddWithValue("@p5", textBoxik17.Text);
            komut32.ExecuteNonQuery();
            // 2. sayfa 18. soru
            NpgsqlCommand komut33 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=33;", baglanti);
            ...
            komut33.Parameters.AddWithValue("@p5", textBoxik18.Text);
            komut33.ExecuteNonQuery();
            // 2. sayfa 19. soru
            NpgsqlCommand komut34 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=34;", baglanti);
            ...
            komut34.Parameters.AddWithValue("@p5", textBoxik19.Text);
            komut34.ExecuteNonQuery();
            // 2. sayfa 20. soru
            NpgsqlCommand komut35 = new NpgsqlCommand($"UPDATE checklist SET label_adi=@p1,kontrol=@p2,aciklama_danisman=@p3,aciklama_yuklenici=@p4,aciklama_isveren=@p5 WHERE soru_id=35;", baglanti);
            ...
            komut35.Parameters.AddWithValue("@p5", textBoxik20.Text);
            komut35.ExecuteNonQuery();

            baglanti.Close();
            MessageBox.Show("Onay Talebi İletildi");
